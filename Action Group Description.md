...
- Configure your `mastodon_instance` and `mastodon_handle` in the `Draftodon Settings` Action by **editing** the Action and changing the corresponding "Define Template Tag" steps of the Action (running the Action does nothing)
